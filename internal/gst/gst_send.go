...
func CreateMicSendPipeline(tracks []*webrtc.TrackLocalStaticSample) *SendPipeline {
	...
	pipelineStr = "pulsesrc ! audioconvert ! opusenc ! appsink name=appsink"
...
func CreateSendPipeline(codecName string, tracks []*webrtc.TrackLocalStaticSample, pipelineSrc string) *SendPipeline {
	pipelineStr := "appsink name=appsink"
	var clockRate float32
